...
namespace Proyecto_Marathon2024.Repository
{
    public class ColorRepository
    {
        ...
        public ColorRepository  (DataAccses dataAccses)
        {
            this.dataAccses = dataAccses;
        }

        public async Task<List<Color>> GetListaColor()
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(dataAccses.GetConnectionString()))
                {
                    ...
                    using (SqlCommand command = new SqlCommand("SP_ListarColor", connection))
                    {
                        ...
                        using (SqlDataReader reader = await command.ExecuteReaderAsync())
                        {
                            ...
                            while (await reader.ReadAsync())
                            {
                                ...
                                Color color = new Color
                                {
                                    ...
                                    Nom_Color = reader.GetString(reader.GetOrdinal("Nom_Color")),
            ...
            {
                // Manejo de errores
                throw new Exception("Error al obtener la lista de color.", ex);
            }
        }
    }
}
